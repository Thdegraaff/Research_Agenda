...
\PaperTitle{Do21 regional economists answer the right questions?}
...
In his controversial and path-breaking article, \citet{breiman2001statistical} describes two different cultures in statistical science. One governed by (probability) theory and by a data-driven approach. These two cultures carry over to the econometric and thus the empirical regional science domain as well, where the theory driven approach still very much dominates the landscape of regional science of today. 
...
\end{equation}
where in (regional) economics language, $\mathbf{x}$ is referred to as the independent variable, $\mathbf{y}$ as the dependent variable and $\epsilon$ as a residual term. 
...
\section{The road to current day's practice\label{Background}}
