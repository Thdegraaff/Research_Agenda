...
made that put the above into perspective.
...
other courses, including the use of statistical software.

\subsubsection{Applied Econometrics}

\subsubsection{Current day practice}
